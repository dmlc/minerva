...
_PHASE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='MULTI_VIEW', index=2, number=2,
      options=None,
      type=None),
  ],
...
_NETPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='input_dim', full_name='caffe.NetParameter.input_dim', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='force_backward', full_name='caffe.NetParameter.force_backward', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='state', full_name='caffe.NetParameter.state', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='debug_info', full_name='caffe.NetParameter.debug_info', index=5,
      number=7, type=8, cpp_type=7, label=1,
      has_default_value=True, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='layer', full_name='caffe.NetParameter.layer', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='layers', full_name='caffe.NetParameter.layers', index=7,
...
_LAYERPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='python_param', full_name='caffe.LayerParameter.python_param', index=33,
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='record_data_param', full_name='caffe.LayerParameter.record_data_param', index=41,
...
_RECORDDATAPARAMETER = _descriptor.Descriptor(
  name='RecordDataParameter',
  full_name='caffe.RecordDataParameter',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='config_path', full_name='caffe.RecordDataParameter.config_path', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=unicode("", "utf-8"),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='batch_size', full_name='caffe.RecordDataParameter.batch_size', index=1,
      number=2, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LAYERPARAMETER.fields_by_name['record_data_param'].message_type = _RECORDDATAPARAMETER
...
DESCRIPTOR.message_types_by_name['RecordDataParameter'] = _RECORDDATAPARAMETER
...
class RecordDataParameter(_message.Message):
  __metaclass__ = _reflection.GeneratedProtocolMessageType
  DESCRIPTOR = _RECORDDATAPARAMETER

  # @@protoc_insertion_point(class_scope:caffe.RecordDataParameter)
