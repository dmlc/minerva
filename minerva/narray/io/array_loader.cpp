...
void ArrayLoaderOp::Execute(DataList& inputs, DataList& outputs, IMPL_TYPE impl_type) {
  CHECK_EQ(impl_type, IMPL_TYPE::BASIC) << "vector loader only has basic implementation";
